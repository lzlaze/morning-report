...
def build_html(futures_data, earnings, econ_events, sectors, analysis, setups_data):
    ...
    # Safely encode analysis for JS using json.dumps (handles backticks, quotes, all special chars)
    analysis_text_for_js = json.dumps(analysis)
...
<!-- Morning context passed safely to external chat widget -->
<script id="morning-context" type="application/json">{analysis_text_for_js}</script>
<script id="report-date" type="application/json">"{TODAY}"</script>
